...
$app['SERVICE_URL'] = 'sitecake/2.4.4/src/app.php';

// URL relative to sitecake.php that Sitecake editor is using to load the login module
$app['EDITOR_LOGIN_URL'] = 'sitecake/2.4.4/client/publicmanager/publicmanager.nocache.js';

// URL relative to sitecake.php that Sitecake editor is using to load the editor module
$app['EDITOR_EDIT_URL'] = 'sitecake/2.4.4/client/contentmanager/contentmanager.nocache.js';

// URL relative to sitecake.php that Sitecake is using to load the pagemanager module
$app['PAGEMANAGER_JS_URL'] = 'sitecake/2.4.4/client/pagemanager/js/pagemanager.2.4.4.js';

// URL relative to sitecake.php that Sitecake is using to load the pagemanager vendor file
$app['PAGEMANAGER_VENDORS_URL'] = 'sitecake/2.4.4/client/pagemanager/js/vendor.2.4.4.js';

// URL relative to sitecake.php that Sitecake is using to load CSS for pagemanager module
$app['PAGEMANAGER_CSS_URL'] = 'sitecake/2.4.4/client/pagemanager/css/pagemanager.2.4.4.css';
